...
def detect_staffs_in_image(
    ...
    title_future = detect_title(debug, staffs[0], config.use_gpu_inference)
...
def main() -> None:
    ...
    has_gpu_support = is_cuda_available()
    ...
    if args.init:
        download_ocr_weights(use_gpu_inference)
    ...
    configure_onnxruntime_logging(args.debug)
